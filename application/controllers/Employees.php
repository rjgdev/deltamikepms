<?php 
   class Employees extends CI_Controller {  
		...
		{	
			...
			$lastname = $this->input->post('lastname');
			$username = $this->input->post('username');
       		$data = $this->employee->save_employee($data,$firstname,$middlename,$lastname,$username);
       		$retval = explode("|",$data);
		...
		public function update()
		{
			...
			$lastname = $this->input->post('lastname');
			$username = $this->input->post('username');
			$data = $this->employee->update_employee($data,$id,$firstname,$middlename,$lastname,$username);
			$retval = explode("|",$data);
