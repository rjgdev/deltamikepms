...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					<h3 class="page-title">Welcome Robinjamin!</h3>
					<ul class="breadcrumb">
					...
					<div class="card-body">
						...
						<div class="leave-info-box">
							<div class="media align-items-center">
								<a href="profile.html" class="avatar"><img alt="" src="<?php echo base_url();?>pages\assets\img\user.jpg"></a>
							...
							<table class="table custom-table mb-0">
								...
								<tbody>
									<tr>
										<td>
											<h2 class="table-avatar">
												<a href="#" class="avatar"><img alt="" src="<?php echo base_url();?>pages\assets\img\profiles\avatar-19.jpg"></a>
												<a href="client-profile.html">Barry Cuda <span>CEO</span></a>
											</h2>
										</td>
										<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aac8cbd8d8d3c9dfcecbeacfd2cbc7dac6cf84c9c5c7">[email&#160;protected]</a></td>
										<td>
									...
									<tr>
										...
										<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1367617660607264766b7f766153766b727e637f763d707c7e">[email&#160;protected]</a></td>
										<td>
											<div class="dropdown action-label">
												<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
									...
									<tr>
										...
										<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dfadaabda6bdbeadabb3baabab9fbaa7beb2afb3baf1bcb0b2">[email&#160;protected]</a></td>
										<td>
											<div class="dropdown action-label">
												<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
													<i class="fa fa-dot-circle-o text-danger"></i> Inactive
									...
									<tr>
										...
										<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b5d8dcc6c1ccc1dcc6dadbf5d0cdd4d8c5d9d09bd6dad8">[email&#160;protected]</a></td>
										<td>
											<div class="dropdown action-label">
												<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
													<i class="fa fa-dot-circle-o text-success"></i> Active
									...
									<tr>
										<td>
											<h2 class="table-avatar">
												<a href="client-profile.html" class="avatar"><img alt="" src="<?php echo base_url();?>pages\assets\img\profiles\avatar-14.jpg"></a>
												<a href="client-profile.html"> Daniel Deacon <span>CEO</span></a>
											</h2>
										</td>
										<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="98fcf9f6f1fdf4fcfdf9fbf7f6d8fde0f9f5e8f4fdb6fbf7f5">[email&#160;protected]</a></td>
										<td>
											<div class="dropdown action-label">
												<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
													<i class="fa fa-dot-circle-o text-danger"></i> Inactive
