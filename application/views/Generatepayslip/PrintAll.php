										...
										<div class="col-sm-6 pr-0">
											...
											<table class="table mb-1">
												<tbody>
													...
													<tr>
														<td><strong>Holiday</strong><i> (included in the basic pay)</i></td>
													</tr>
													<tr>
														<td><strong class="ml-3">Regular</strong> <span class="float-right">₱ <?=number_format($item->rgl,4,".",",")?></span></td>
													</tr>
													<tr>
														<td><strong class="ml-3">Double</strong> <span class="float-right">₱ <?=number_format($item->dbl,4,".",",")?></span></td>
													</tr>
													<tr>
														<td><strong class="ml-3">Special</strong> <span class="float-right">₱ <?=number_format($item->spc,4,".",",")?></span></td>
													</tr>
